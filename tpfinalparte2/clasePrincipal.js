class Principal {
  constructor() {
    ...
    this.palmera= new Palmera(999, 210, "data/palmera.png");
    this.piedra = new Piedra(640, 268, "data/piedra.png");
    this.pajaro= new Pajaro(870, 150, "data/pajaro.png");
    this.vidasLlenas=[];
  ...
  descontarVida() {
    for (let i=0; i<2; i++) {
      if (this.vidasLlenas[i].visible) {
        this.vidasLlenas[i].visible=false;
        this.vidasVacias[i].visible=true;
        if (i==1) {
          this.jugadorPierde();
        }
        break;
